...
function ejectComponent(analysis, name, symbolIndex) {
  ...
  const header = [
    '// Frei bearbeitbare Kopie — benötigte Imports:',
    ...importLines.sort().map((l) => `// ${l}`),
  ].join('\n');
...
export function generateEjectSources(options = {}) {
  ...
  for (const name of names) {
    ...
    sources[name] = result.code;
  }

  const out = [
    '// AUTO-GENERATED by scripts/gen-eject-sources.mjs — do not edit by hand.',
    '// Editable component sources for the gallery "Quelltext" (eject) action.',
    '',
    'export const EJECT_SOURCES: Record<string, string> = ',
